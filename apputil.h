...
int appf_zipstdio(const char *, int verb);
int appf_closefds(int fd, int maxfd, int verb);
int appf_mountpoint(const char *);
...
#define APPUTIL_OPTION_EXEC      0x80
#define APPUTIL_OPTION_SYMLINK   0x100
#define APPUTIL_OPTION_RSTRIP    0x200
